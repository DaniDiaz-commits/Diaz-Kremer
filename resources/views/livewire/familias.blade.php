            ...
            <tbody>
                ...
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    ...
                    <td class="px-6 py-2 flex justify-center gap-2">
                        <flux:button variante="primary" size="sm" wire:click="edit({{ $familia->id }})">Edit</flux:button>
                        <flux:button variant="danger" size="sm" wire:click="delete({{ $familia->id }})">Delete</flux:button>
                    </td>
                </tr>
                @endforeach
            </tbody>
