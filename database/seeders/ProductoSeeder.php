...
class ProductoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->productier('#000001', 'Parrilla barbacoa 40x40', 'Parrilla para una barbacoa tamaño 40x40.', 250, 50, 5, 1, 1,  asset('img/productos/12982_1.jpg'));
        $this->productier('#000002', 'Parrilla barbacoa 45x45', 'Parrilla para una barbacoa tamaño 45x45.', 250, 50, 5, 1, 1, asset('img/productos/12985_1.jpg'));
        $this->productier('#000003', 'Copas Calices', 'Para beber un vinito como un rey.', 250, 50, 5, 1, 1, asset('img/productos/20101_AR.jpg'));
        $this->productier('#000004', 'Bolsilla para body care', 'Bolso para cuidado del cuerpo.', 250, 50, 5, 1, 1, asset('img/productos/20199_1.jpg'));
        $this->productier('#000005', 'Bandeja plástico', 'Bandeja de plastica, estilo tropical.', 250, 50, 5, 1, 1, asset('img/productos/87409_AR.jpg'));
        $this->productier('#000006', 'Brocha de afeitar', 'Brocha de afeitar para hombre.', 250, 50, 5, 1, 1, asset('img/productos/60792.jpg'));
        $this->productier('#000007', 'Pack de botellas de cristal de 1L', '6 Botellas de cristal de 1L .', 250, 50, 5, 1, 1, asset('img/productos/79887_AR.jpg'));
        $this->productier('#000008', 'Pack de botellas de cristal de 750cc', '6 Botellas de cristal de 750cc .', 250, 50, 5, 1, 1, asset('img/productos/79888_AR.jpg'));
        $this->productier('#000009', 'Soporte para jamón', 'Soporte para un presunto porte-jamon .', 250, 50, 5, 1, 1, asset('img/productos/55083_AR.jpg'));
        $this->productier('#000010', 'Tabla de planchar', 'Tabla de planchar mediana .', 250, 50, 5, 1, 1, asset('img/productos/11586_AR.jpg'));
        $this->productier('#000011', 'Lupa', 'Lupa de la marca pincello.', 250, 50, 5, 1, 1, asset('img/productos/21853_1.jpg'));
        $this->productier('#000012', 'Tartera de cristal', 'Tartera de cristal para 1,5L.', 250, 50, 5, 1, 1, asset('img/productos/25852_AR.jpg'));
        $this->productier('#000013', 'Saca-puntas de metal', 'Saca puntas de metal marca pincello.', 250, 50, 5, 1, 1, asset('img/productos/29049_1.jpg'));
        ...
        $this->productier('#000018', 'Bote de cola blanca', 'Bote de cola blanca.', 250, 50, 5, 1, 1, asset('img/productos/57717.jpg'));
        ...
        $this->productier('#000023', 'Paraguas pequeño', 'Paraguas pequeño de tela.', 250, 50, 5, 467, 12, asset('img/productos/79797_AR.jpg'));
        $this->productier('#000024', 'Pack de paraguas tricolor', 'Pack de 18 paraguas .', 250, 50, 5, 467, 12, asset('img/productos/88735_AR.jpg'));
        $this->productier('#000025', 'Paraguas transparente', 'Paraguas de plástico transparente .', 250, 50, 5, 467, 12, asset('img/productos/88814_AR.jpg'));
        $this->productier('#000026', 'Pinzas de sujección', 'Pinzas de sujección .', 250, 50, 5, 1, 1, asset('img/productos/0.jpg'));
        $this->productier('#000027', 'Bolsa de paja', 'Bolsa de paja mediana .', 250, 50, 5, 1, 1, asset('img/productos/86566.jpg'));
        $this->productier('#000028', 'Velas de cumpleaños', 'Velas de cumpleaños con soporte a parte .', 250, 50, 5, 1, 1, asset('img/productos/21200.jpg'));
